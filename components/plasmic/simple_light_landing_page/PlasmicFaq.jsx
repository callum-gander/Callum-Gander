...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: eR7O-tD-c4_bmG/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box___0DKKh)}
      >
        <div className={classNames(defaultcss.all, sty.box___8Hq2)}>
          <div className={classNames(defaultcss.all, sty.box___3YJO)}>
            {p.renderPlasmicSlot({
