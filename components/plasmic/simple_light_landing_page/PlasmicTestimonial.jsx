...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: a1aWPrmZ-Fvwt_/css
import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: LAjYuV0KZbagnz/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__mlDbw)}
      >
        <div
