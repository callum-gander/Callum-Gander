...
import * as sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: mGrE-lhOL19U2/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.box__qUlKp, {
            [sty.box__long__qUlKp3TiP]: hasVariant(variants, "long", "long")
          })}
        >
          <div
            className={classNames(defaultcss.all, sty.box__uCfCo, {
              [sty.box__long__uCfCo3TiP]: hasVariant(variants, "long", "long")
            })}
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(defaultcss.all, sty.svg__xmpg2)}
                  role={"img"}
                />
              ),
      ...
      <div
        className={classNames(defaultcss.all, sty.box__f9M3, {
          [sty.box__long__f9M33TiP]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__xX0V5, {
            [sty.box__long__xX0V53TiP]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__otpqf)}
                role={"img"}
              />
            ),
