...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: USHmTAaipP19l8/css
...
function PlasmicBaseCard__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__dXn6B, {
          [sty.box__long__dXn6BCwWtc]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__fMa, {
            [sty.box__long__fMaCwWtc]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg___6HlVe)}
                role={"img"}
              />
            ),
