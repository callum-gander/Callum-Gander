...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: HeKZPZtkttskj/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__aX2ZR)}
              role={"img"}
            />
          ),
